...
namespace Dalamud.Updater
{
    ...
    {
        private const string UPDATEURL = "https://ndiv.rayd.cc/Updater/Release/VersionInfo";
        private const string DOHWAHOME = "문의 : 달라가브 KR 디스코드 https://discord.gg/r5pfQjveDM";
        ...
        public FormMain()
        {
            ...
            runtimeDirectory = new DirectoryInfo(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "XIVLauncher", "runtime"));
        ...
        {
            Process.Start("https://discord.gg/r5pfQjveDM");
        }
